...
export default function Details({params}) {
    ...
    useEffect(() => {
        ...
        getDoctorDetailsById(documentId,i18n.language);
    }, [documentId,i18n.language]);

    const getDoctorDetailsById = (documentId, locale) => {
       setLoading(true);
        Api.getDoctorByID(documentId,locale)
        .then((res) => {
  ...
  return (
    <div className='p-5 md:px-20 pt-30'>
        <h2 className='font-bold text-[22px]'>{t('docDetails')}</h2>
