...
export default function Footer() {
    return (
        <footer className="bg-white border-t border-lime-600">
                ...
                <div className="lg:flex lg:items-start lg:gap-8">
                    ...
                    <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            ...
                            <ul className="mt-6 space-y-4 text-sm">
                                <li><a href="#" className="text-gray-700 transition hover:opacity-75">Marketing Calendar</a></li>
                                <li><a href="#" className="text-gray-700 transition hover:opacity-75">SEO Infographics</a></li>
                            </ul>
                        </div>
                        ...
                        <ul className="col-span-2 flex justify-start gap-6 lg:col-span-5 lg:justify-end">
                            ...
                            {/* Add the rest of social icons similarly */}
                        </ul>
                    </div>
                </div>
